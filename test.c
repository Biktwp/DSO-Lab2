...
int main()
{
	...
	fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 1 creating 10 directories 3 ", ANSI_COLOR_GREEN, "SUCCESS\n", ANSI_COLOR_RESET);
	...
	else fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 35 open file for write ", ANSI_COLOR_GREEN, "SUCCESS\n", ANSI_COLOR_RESET);
	...
	/*
	 * Test 36: Unmount the filesystem mount againg and see if the files and directories are in the file system.
	 * Expected: Write meta data in disk and print in terminal the files and directories.
	 */
	ret = unmountFS();
	if (ret != 0)
	{
		fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 unmountFS ", ANSI_COLOR_RED, "FAILED\n", ANSI_COLOR_RESET);
		return -1;
	}

	fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 unmountFS ", ANSI_COLOR_GREEN, "SUCCESS\n", ANSI_COLOR_RESET);

	 ret = mountFS();
	if (ret != 0)
	{
		fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 mountFS ", ANSI_COLOR_RED, "FAILED\n", ANSI_COLOR_RESET);
		return -1;
	}
	fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 mountFS ", ANSI_COLOR_GREEN, "SUCCESS\n", ANSI_COLOR_RESET);
	
    ret = lsDir("/",inodesDir,namesDir);
	if (ret < 0) fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 ls / ", ANSI_COLOR_RED, "FAILED\n", ANSI_COLOR_RESET);
	else fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 ls / ", ANSI_COLOR_GREEN, "SUCCESS\n", ANSI_COLOR_RESET);

    fd = openFile("/file.txt");
	if (fd < 0)
	{
		fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 open file for wrtie ", ANSI_COLOR_RED, "FAILED\n", ANSI_COLOR_RESET);
		
	}
	else fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 open file for write ", ANSI_COLOR_GREEN, "SUCCESS\n", ANSI_COLOR_RESET);

    ret = readFile(fd, result, 5);
	if (ret != 5)
	{
		fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 read ", ANSI_COLOR_RED, "FAILED\n", ANSI_COLOR_RESET);
		
	}
	else fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 read ", ANSI_COLOR_GREEN, "SUCCESS\n", ANSI_COLOR_RESET);


	ret = lseekFile(fd, 0, FS_SEEK_BEGIN);
	if (ret != 0)
	{
		fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 lseek file for read ", ANSI_COLOR_RED, "FAILED\n", ANSI_COLOR_RESET);
		
	}
	else fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 lseek file for read ", ANSI_COLOR_GREEN, "SUCCESS\n", ANSI_COLOR_RESET);
	...
	if (ret < 0)
	{
		fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 close file ", ANSI_COLOR_RED, "FAILED\n", ANSI_COLOR_RESET);
		
	}
	else fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "TEST 36 close file ", ANSI_COLOR_GREEN, "SUCCESS\n", ANSI_COLOR_RESET);

	ret = unmountFS();
	if (ret != 0)
	{
		fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "FINAL TEST unmountFS ", ANSI_COLOR_RED, "FAILED\n", ANSI_COLOR_RESET);
		return -1;
	}
	fprintf(stdout, "%s%s%s%s%s", ANSI_COLOR_BLUE, "FINAL TEST unmountFS ", ANSI_COLOR_GREEN, "SUCCESS\n", ANSI_COLOR_RESET);
